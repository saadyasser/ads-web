...
const navigation = [
  { name: "Dashboard", href: "#", icon: <p>hi</p>, current: true },
  { name: "Team", href: "#", icon: <p>hi</p>, current: false },
  { name: "Projects", href: "#", icon: <p>hi</p>, current: false },
  { name: "Calendar", href: "#", icon: <p>hi</p>, current: false },
  { name: "Documents", href: "#", icon: <p>hi</p>, current: false },
  { name: "Reports", href: "#", icon: <p>hi</p>, current: false },
];
