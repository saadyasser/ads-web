...
export const uploadCategoryImages = async (image: FormData) => null;
...
export const createCategory = async (category: unknown) => null;
...
export const listCategories = async (queries?: string[]) => null;
...
//   }
// };
export const getCategoryIdByName = async (categoryName: string) => null;
...
//   }
// };
export const updateCategory = async (id: string, payload: any) => null;
...
//   }
// };
export const deleteCategory = async (id: string) => null;
